...
class Student:
    def __init__(self,root):
        ...
        title = Label(self.root, text="Student Managment System",bd=10,relief=GROOVE, font=("times new roman",40,"bold"), bg="#0099ff", fg="#000")
        title.pack(side=TOP, fill=X)
        
        # manage frame
        manag_frame = Frame(self.root, bd=4, relief=RIDGE,bg="#0099ff")
        manag_frame.place(x=20,y=100,width=450, height=650)
        
        m_title=Label(manag_frame, text="Manage Student", font=("times new roman",30,"bold"),bg="#0099ff", fg="white")
        m_title.grid(row=0,columnspan=2,pady=20)
        
      
        #label details
        lbl_frame_roll = Label(manag_frame, text="Roll No:", font=("times new roman",20,"bold"),bg="#0099ff", fg="white")
        ...
        lbl_frame_name = Label(manag_frame, text="Name:", font=("times new roman",20,"bold"),bg="#0099ff", fg="white")
        ...
        lbl_frame_email = Label(manag_frame, text="Email:", font=("times new roman",20,"bold"),bg="#0099ff", fg="white")
        ...
        lbl_gender = Label(manag_frame, text="Gender:", font=("times new roman",20,"bold"),bg="#0099ff", fg="white")
        ...
        lbl_contact = Label(manag_frame, text="Contact:", font=("times new roman",20,"bold"),bg="#0099ff", fg="white")
        ...
        lbl_dob = Label(manag_frame, text="D.O.B:", font=("times new roman",20,"bold"),bg="#0099ff", fg="white")
        lbl_dob.grid(row=6,column=0,pady=10,padx=20, sticky="w")
        
        txt_dob =Entry(manag_frame,textvariable=self.dob_var,font=("times new roman",15,"bold"), bd=5, relief=GROOVE)
        txt_dob.grid(row=6,column=1,pady=10,padx=20, sticky="w")

        lbl_address = Label(manag_frame, text="Address:", font=("times new roman",20,"bold"),bg="#0099ff", fg="white")
        ...
        # button frame
        btn_frame=Frame(manag_frame,bd=4,relief=RIDGE, bg="#0099ff") 
  ...
  # dtails frame
        ...
        lbl_search = Label(detail_frame, text="Search By", font=("times new roman",20,"bold"),bg="#0099ff", fg="white")
